...
## Purpose
The dashboard that reads a format's stored metagame breakdown from Supabase and renders the ranked top-20 archetype grid, including format selection/persistence, the freshness indicator, loading/empty/error states, and bilingual (ES/EN) copy.
