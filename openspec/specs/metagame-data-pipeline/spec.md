...
## Purpose
The Supabase schema (formats, archetypes, metagame snapshots, freshness) and the MTGTop8 scraper that populates the Last 2 Weeks archetype breakdown for all five formats, run daily via GitHub Actions and readable read-only by the browser.
