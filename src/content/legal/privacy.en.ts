...
export const privacyEn: Section[] = [
  ...
  { type: 'heading', text: 'Error tracking' },
  {
    type: 'paragraph',
    text: [
      'We use error-tracking tools to help us notice and fix bugs when something breaks on the site. These tools may record technical details about what went wrong (like which page and what error occurred), but are not used to build a profile of who you are.',
    ],
  },
  ...
  { type: 'heading', text: 'Changes to this policy' },
  {
    type: 'paragraph',
    text: [
      'If our data practices change — for example, when we choose an error-tracking or advertising provider — we will update this page to reflect it.',
    ],
  },
  { type: 'note', text: 'Last changed: 16-07-2026' },
]
